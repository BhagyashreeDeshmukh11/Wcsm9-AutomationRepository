...
public class HandleWithDisableElement {
	public static void main(String[] args) throws InterruptedException {
		...
		jse.executeScript("document.getElementById('name').value='Bhagyashree'");
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('email').value='bhagyashree@gmail.com'");
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('password').value='Bhagya@123'\r\n"
				+ "");
